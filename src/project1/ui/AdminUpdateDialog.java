...
public class AdminUpdateDialog extends JDialog {
	...
	public static void main(String[] args) throws Exception {
		try {
			AdminUpdateDialog dialog = new AdminUpdateDialog();
	...
	public void setUpdateAdmin(Admin updateAdmin) {
		...
		adminnoTF.setText(updateAdmin.getNo()+"");
		adminnameTF.setText(updateAdmin.getName());
		adminidTF.setText(updateAdmin.getId());
		adminpassTF.setText(updateAdmin.getPassword());
		admincallTF.setText(updateAdmin.getPhoneNo());	
	}
	
	public AdminUpdateDialog() throws Exception{
		...
		JLabel lblNewLabel = new JLabel("\uC9C1\uC6D0\uC218\uC815");
		...
		//직급선택박스
		JComboBox positionCB = new JComboBox();
		positionCB.setModel(new DefaultComboBoxModel(new String[] {"직급선택", "직원", "매니저", "사장"}));
				...
				okButton.addActionListener(new ActionListener() {
					...
					public void actionPerformed(ActionEvent e) {
						try {
							...
							adminService.updateAdmin((new Admin(Integer.parseInt(noStr), nameStr, idStr, passStr, callStr, position)));
